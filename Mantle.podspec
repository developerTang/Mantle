...
Pod::Spec.new do |s|
  ...
  s.author             = { "developerTang" => "email@address.com" }
  # Or just: s.author    = "developerTang"
  # s.authors            = { "developerTang" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/developerTang"
